...
Priya" and "add Priya and also change 14 unrelated things", and reviewers
...
- There is no closing `---`
- A required line (`name`, `github`, `branch`) is missing or blank
...
```
contributors/priya-sharma.md    ← file name:  priya-sharma
github: priyasharma             ← inside it:  priyasharma
```
